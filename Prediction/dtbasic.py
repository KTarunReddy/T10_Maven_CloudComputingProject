...
#D:/CloudComputing/CourseProject/Data/Merge/Reduction/FeatureGeneration/Prediction/
...
# Building the model
t0 = time()
tree_model = DecisionTree.trainClassifier(parsedTrainData, numClasses=2, 
                                          categoricalFeaturesInfo={},
                                          impurity='gini', maxDepth=20, maxBins=30)
tt = time() - t0
